      ...
      <main className="flex-grow pt-24 bg-[#FFF9F0]">
        ...
        <section className="py-16 sm:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-20">
              <div className="camp-card relative overflow-hidden text-white p-8 md:p-12 border-2 border-black/10 flex flex-col md:flex-row items-center justify-between gap-8" style={{ backgroundColor: '#8B6FE8' }}>
