              ...
              >
                ...
                <div className="p-8 flex-grow flex flex-col justify-between">
                  <div>
                    ...
                    <h2 className="font-display font-extrabold text-xl sm:text-2xl text-[#1A1A2E] leading-snug hover:text-[#4A90D9] transition-colors">
                      {article.title}
                    </h2>
                  ...
                  <div className="mt-8 pt-6 border-t border-black/5">
                    <span
                      className="font-body font-extrabold text-sm text-[#4A90D9] flex items-center gap-2 hover:scale-105 transition-transform w-fit cursor-pointer"
                    >
                      Read more
